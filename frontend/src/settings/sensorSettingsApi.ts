...
const DEFAULT_SENSORS: SensorDisplaySetting[] = [
  {
    ...
    label: "Front scanner",
    scanner: true,
    display_pose: { x_m: 0, y_m: 0.32, z_m: 0.32, yaw_deg: 0, pitch_deg: 0 },
  ...
  },
  {
    ...
    label: "Front fixed",
    scanner: false,
    display_pose: { x_m: 0, y_m: 0.55, z_m: 0.32, yaw_deg: 0, pitch_deg: -50 },
  ...
  },
  {
    ...
    label: "Rear scanner",
    scanner: true,
    display_pose: { x_m: 0, y_m: -0.55, z_m: 0.32, yaw_deg: 180, pitch_deg: 0 },
    alert_distance_m: 0.7,
    visual_range_m: 4,
  },
  {
    ...
    label: "Left fixed",
    scanner: false,
    display_pose: { x_m: -0.36, y_m: 0, z_m: 0.32, yaw_deg: -90, pitch_deg: -50 },
