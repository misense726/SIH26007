...
constexpr uint8_t kScannerTcaChannel = 0;
constexpr uint8_t kLeftSideTcaChannel = 1;
constexpr uint8_t kRightSideTcaChannel = 2;

const fogsen::NodeConfig kNodeConfig = {
    "REAR",                     // node_id
    "REAR BOOT",                // boot_message
    ...
    kTcaAddress,                 // tca_address
    kScannerTcaChannel,          // scanner_tca_channel
    kLeftSideTcaChannel,         // fixed_a_tca_channel
    kRightSideTcaChannel,        // fixed_b_tca_channel
    115200,                      // debug_baud
