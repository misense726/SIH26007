...
```powershell
arduino-cli compile --warnings all --fqbn "esp32:esp32:esp32c3:CDCOnBoot=cdc" firmware/middle_esp32c3_supermini
arduino-cli upload --port COM8 --fqbn "esp32:esp32:esp32c3:CDCOnBoot=cdc" firmware/middle_esp32c3_supermini
```
