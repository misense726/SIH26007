...
constexpr uint8_t kFrontLeftTcaChannel = 1;
constexpr uint8_t kFrontRightTcaChannel = 2;
...
const fogsen::NodeConfig kNodeConfig = {
    ...
    kFrontLeftTcaChannel,        // fixed_a_tca_channel
    kFrontRightTcaChannel,       // fixed_b_tca_channel
    115200,                      // debug_baud
